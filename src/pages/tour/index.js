...
function Tour() {
    ...
    return (
        <>
            <Head>
                <title>SIBÖ CHOCOLATE | Chocolate Tour</title>
                <meta
                    name="description"
                    content="Sibö Chocolate’s interactive tasting experience and presentation on the history of chocolate at our artisan chocolate workshop in San Isidro de Heredia, Costa Rica."
                />
            </Head>
            <Layout>
                <DesktopContainer>
