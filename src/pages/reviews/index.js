...
function Reviews() {
    ...
    return (
        <>
            <Head>
                <title>SIBÖ CHOCOLATE | Reviews</title>
                <meta
                    name="description"
                    content={`See latest reviews for Sibö Chocolate, "This is literally the best chocolate I've ever eaten. And I've had a lot of chocolate"`}
                />
            </Head>
            <Layout>
                <DesktopContainer>
